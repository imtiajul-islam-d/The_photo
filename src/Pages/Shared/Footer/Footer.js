...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-blue-800 text-white dark:bg-gray-800 dark:text-gray-100">
      <div className="container flex flex-col justify-center lg:justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 text-center lg:text-start">
        <div className="flex justify-center lg:justify-start items-center lg:w-1/3">
          ...
          >
            <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400 text-3xl">
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">
        © 2022 The Photo. All rights reserved.
      </div>
    </footer>
  );
};
